...
.nav-link.active {
    color: black; /* Warna menu aktif */
    font-weight: bold; /* Teks tebal untuk menu aktif */
}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo (isset($_GET['page']) && $_GET['page'] == 'gallery') ? 'active' : ''; ?>" href="admin.php?page=gallery">Gallery</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo (isset($_GET['page']) && $_GET['page'] == 'homepage') ? 'active' : ''; ?>" href="admin.php?page=homepage">Homepage</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-danger fw-bold" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?= $_SESSION['username'] = 'Aldi'; ?>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="logout.php">Logout</a></li>
                        <li><a class="dropdown-item" href="profile_data.php">Profil Aldi</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<!-- content end -->
    ...
    <div>
        ...
        ></a>
        <a href="https://wa.me/+6282279865092"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Aldi &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
